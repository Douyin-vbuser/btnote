        ...
        if (flag) {
            if (state.getValue(PITCH) == 3) {
                ...
                if (block == Blocks.OBSIDIAN){
                    worldIn.playSound(null,pos,SoundsHandler.BLOCK_NOTE_SIX_STRINGS_3,SoundCategory.BLOCKS,3.0F,1.0F);
                }
            ...
            if (state.getValue(PITCH) == 2) {
                ...
                if (block == Blocks.OBSIDIAN){
                    worldIn.playSound(null,pos,SoundsHandler.BLOCK_NOTE_SIX_STRINGS_2,SoundCategory.BLOCKS,3.0F,1.0F);
                }
                if (block == Blocks.PLANKS){
            ...
            if (state.getValue(PITCH) == 1) {
                ...
                if (block == Blocks.OBSIDIAN){
                    worldIn.playSound(null,pos,SoundsHandler.BLOCK_NOTE_SIX_STRINGS_1,SoundCategory.BLOCKS,3.0F,1.0F);
                }
                if (block == Blocks.PLANKS){
            ...
            if (state.getValue(PITCH) == 4) {
                ...
                if (block == Blocks.OBSIDIAN){
                    worldIn.playSound(null,pos,SoundsHandler.BLOCK_NOTE_SIX_STRINGS_4,SoundCategory.BLOCKS,3.0F,1.0F);
                }
                if (block == Blocks.PLANKS){
            ...
            if (state.getValue(PITCH) == 5) {
                ...
                if (block == Blocks.OBSIDIAN){
                    worldIn.playSound(null,pos,SoundsHandler.BLOCK_NOTE_SIX_STRINGS_5,SoundCategory.BLOCKS,3.0F,1.0F);
                }
                if (block == Blocks.PLANKS){
