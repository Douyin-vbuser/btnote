...
public class Note_seven extends BlockBase {
    ...
    //private static final List<SoundEvent> INSTRUMENTS = Lists.newArrayList(SoundsHandler.BLOCK_NOTE_SEVEN_PIANO_1,SoundsHandler.BLOCK_NOTE_SEVEN_PIANO_2,SoundsHandler.BLOCK_NOTE_SEVEN_PIANO_3,SoundsHandler.BLOCK_NOTE_SEVEN_PIANO_4,SoundsHandler.BLOCK_NOTE_SEVEN_PIANO_5,SoundsHandler.BLOCK_NOTE_SEVEN_ELECTRIC_1,SoundsHandler.BLOCK_NOTE_SEVEN_ELECTRIC_2,SoundsHandler.BLOCK_NOTE_SEVEN_ELECTRIC_3,SoundsHandler.BLOCK_NOTE_SEVEN_ELECTRIC_4,SoundsHandler.BLOCK_NOTE_SEVEN_ELECTRIC_5,SoundsHandler.BLOCK_NOTE_SEVEN_STRINGS_1,SoundsHandler.BLOCK_NOTE_SEVEN_STRINGS_2,SoundsHandler.BLOCK_NOTE_SEVEN_STRINGS_3,SoundsHandler.BLOCK_NOTE_SEVEN_STRINGS_4,SoundsHandler.BLOCK_NOTE_SEVEN_STRINGS_5,SoundsHandler.BLOCK_NOTE_SEVEN_GUITAR_1,SoundsHandler.BLOCK_NOTE_SEVEN_GUITAR_2,SoundsHandler.BLOCK_NOTE_SEVEN_GUITAR_3,SoundsHandler.BLOCK_NOTE_SEVEN_GUITAR_4,SoundsHandler.BLOCK_NOTE_SEVEN_GUITAR_5);
    ...
    public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ){
        ...
        if(playerIn.getHeldItemMainhand().getItem() == Item.getItemFromBlock(Blocks.DIRT)){
            worldIn.setBlockState(pos, ModBlocks.PIANO_SEVEN.getBlockState().getBaseState().withProperty(Piano_seven.PITCH,(state.getValue(PITCH)+1)).withProperty(Piano_seven.HARD,false), 2);
                    ...
                    Block block = iblockstate.getBlock();
                        ...
                        if (state.getValue(PITCH) == 3) {
                            ...
                            if (block == Blocks.OBSIDIAN){
                                if(state.getValue(LONE)){worldIn.playSound(null,pos,SoundsHandler.BLOCK_NOTE_SEVEN_STRINGS_3,SoundCategory.BLOCKS,3.0F,1.0F);}
                                else{worldIn.playSound(null,pos,SoundsHandler.BLOCK_NOTE_SEVEN_STRINGS_3_SHORT,SoundCategory.BLOCKS,3.0F,1.0F);}
                            }
                            ...
                            if(block == Blocks.LEAVES){
                                worldIn.playSound(null,pos,SoundsHandler.BLOCK_NOTE_SEVEN_WOODWIND_3,SoundCategory.BLOCKS,3.0F,1.0F);
                            }
                        }
                        if (state.getValue(PITCH) == 2) {
                            ...
                            if (block == Blocks.OBSIDIAN){
                                if(state.getValue(LONE)){worldIn.playSound(null,pos,SoundsHandler.BLOCK_NOTE_SEVEN_STRINGS_2,SoundCategory.BLOCKS,3.0F,1.0F);}
                                else{worldIn.playSound(null,pos,SoundsHandler.BLOCK_NOTE_SEVEN_STRINGS_2_SHORT,SoundCategory.BLOCKS,3.0F,1.0F);}
                            }
                            if (block == Blocks.PLANKS){
                            ...
                            if(block == Blocks.LEAVES){
                                worldIn.playSound(null,pos,SoundsHandler.BLOCK_NOTE_SEVEN_WOODWIND_2,SoundCategory.BLOCKS,3.0F,1.0F);
                            }
                        }
                        ...
                        if (state.getValue(PITCH) == 1) {
                            ...
                            if (block == Blocks.OBSIDIAN){
                                if(state.getValue(LONE)){worldIn.playSound(null,pos,SoundsHandler.BLOCK_NOTE_SEVEN_STRINGS_1,SoundCategory.BLOCKS,3.0F,1.0F);}
                                else{worldIn.playSound(null,pos,SoundsHandler.BLOCK_NOTE_SEVEN_STRINGS_1_SHORT,SoundCategory.BLOCKS,3.0F,1.0F);}
                            }
                            if (block == Blocks.PLANKS){
                            ...
                            if(block == Blocks.LEAVES){
                                worldIn.playSound(null,pos,SoundsHandler.BLOCK_NOTE_SEVEN_WOODWIND_1,SoundCategory.BLOCKS,3.0F,1.0F);
                            }
                        }
                        if (state.getValue(PITCH) == 4) {
                            ...
                            if (block == Blocks.OBSIDIAN){
                                if(state.getValue(LONE)){worldIn.playSound(null,pos,SoundsHandler.BLOCK_NOTE_SEVEN_STRINGS_4,SoundCategory.BLOCKS,3.0F,1.0F);}
                                else{worldIn.playSound(null,pos,SoundsHandler.BLOCK_NOTE_SEVEN_STRINGS_4_SHORT,SoundCategory.BLOCKS,3.0F,1.0F);}
                            }
                            if (block == Blocks.PLANKS){
                            ...
                            if(block == Blocks.LEAVES){
                                worldIn.playSound(null,pos,SoundsHandler.BLOCK_NOTE_SEVEN_WOODWIND_4,SoundCategory.BLOCKS,3.0F,1.0F);
                            }
                        }
                        if (state.getValue(PITCH) == 5) {
                            ...
                            if (block == Blocks.OBSIDIAN){
                                if(state.getValue(LONE)){worldIn.playSound(null,pos,SoundsHandler.BLOCK_NOTE_SEVEN_STRINGS_5,SoundCategory.BLOCKS,3.0F,1.0F);}
                                else{worldIn.playSound(null,pos,SoundsHandler.BLOCK_NOTE_SEVEN_STRINGS_5_SHORT,SoundCategory.BLOCKS,3.0F,1.0F);}
                            }
                            if (block == Blocks.PLANKS){
                            ...
                            if(block == Blocks.LEAVES){
                                worldIn.playSound(null,pos,SoundsHandler.BLOCK_NOTE_SEVEN_WOODWIND_5,SoundCategory.BLOCKS,3.0F,1.0F);
                            }
                        }
                    }
