...
public class Piano_two extends BlockBase {
    ...
    public Piano_two(String name, Material material, CreativeTabs tab) {
    ...
    public void neighborChanged(IBlockState state, World worldIn, BlockPos pos, Block blockIn, BlockPos fromPos) {
        ...
        if (tileentity instanceof TileEntityPianoTwo) {
            TileEntityPianoTwo tileEntityPianoTwo = (TileEntityPianoTwo) tileentity;

            if (tileEntityPianoTwo.previousRedstoneState != flag) {
                if (flag) {
                    if(state.getValue(HARD)) {
                        ...
                        if (state.getValue(PITCH) == 1) {
                            worldIn.playSound(null, pos, SoundsHandler.BLOCK_PIANO_TWO_1, SoundCategory.BLOCKS, 1.0F, 1.0F);
                        }
                        if (state.getValue(PITCH) == 2) {
                            worldIn.playSound(null, pos, SoundsHandler.BLOCK_PIANO_TWO_2, SoundCategory.BLOCKS, 1.0F, 1.0F);
                        }
                        if (state.getValue(PITCH) == 3) {
                            worldIn.playSound(null, pos, SoundsHandler.BLOCK_PIANO_TWO_3, SoundCategory.BLOCKS, 1.0F, 1.0F);
                        }
                        if (state.getValue(PITCH) == 4) {
                            worldIn.playSound(null, pos, SoundsHandler.BLOCK_PIANO_TWO_4, SoundCategory.BLOCKS, 1.0F, 1.0F);
                        }
                        if (state.getValue(PITCH) == 5) {
                            worldIn.playSound(null, pos, SoundsHandler.BLOCK_PIANO_TWO_5, SoundCategory.BLOCKS, 1.0F, 1.0F);
                        }
                        if (state.getValue(PITCH) == 6) {
                            worldIn.playSound(null, pos, SoundsHandler.BLOCK_PIANO_TWO_6, SoundCategory.BLOCKS, 1.0F, 1.0F);
                        }
                        if (state.getValue(PITCH) == 7) {
                            worldIn.playSound(null, pos, SoundsHandler.BLOCK_PIANO_TWO_7, SoundCategory.BLOCKS, 1.0F, 1.0F);
                        }
                    }
                }
                tileEntityPianoTwo.previousRedstoneState = flag;
            }
        }
    }
}
